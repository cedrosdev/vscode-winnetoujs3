      ...
      <body>
        <div class="error-container">
          ...
          <div class="more-info" id="moreInfo">
            <p>To resolve this issue, ensure that the <code>winnetoujs.fullPath</code> is correctly set in your workspace settings.</p>
            <p>Steps:</p>
            <ol>
              ...
              <code>{
  "settings": {
    "winnetoujs.fullPath": "/path/to/your/winnetou/project"
  }
}</code>
